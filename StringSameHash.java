...
public class StringSameHash {
    
    public static void main(String[] args) {
        String test1 = "Cybersecurity";
        ...
        StringSameHash ssh = new StringSameHash();
        ssh.printHashValues(test1);
    }
     
    private void printHashValues(String str) {
        System.out.println("Original Hash value : " + str + " hash is " + str.hashCode());
            ...
            if (delta2 != 0) {
                ...
                if (isInRange2) {
                    ...
                    if (isInRange1) {
                        ...
                        System.out.println("String wiht same Hash value --> "+str2 + " hash is -> " + str2.hashCode());
                    }
                }
            }
        }
